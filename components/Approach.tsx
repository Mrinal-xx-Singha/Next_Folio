    ...
    <section className="w-full py-20" id="approach">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          icon={<AceternityIcon order="Stage1" />}
          description="I will collaborate to map out your websites goals,target audiance and key functionalities,We will discuss things like site structure , navigation,content requirement"
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
